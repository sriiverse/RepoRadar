...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden select-none bg-[#050816]">
      ...
      {/* ── TOP UTILITY BAR ── */}
      <div className="relative z-30 w-full border-b border-white/[0.08] bg-white/[0.02] px-8 md:px-12 py-3.5 flex items-center justify-between text-xs md:text-sm font-mono text-slate-300">
        <div className="flex items-center gap-2.5 select-none">
          <span className="status-dot green animate-pulse-glow" style={{ width: "8px", height: "8px" }} />
          <span>
            BUILT BY <span className="neon-text-cyan font-extrabold tracking-wider text-white bg-white/[0.04] px-2 py-1 rounded border border-white/[0.08] shadow-[0_0_15px_rgba(0,245,255,0.15)]">SUDHANSHU SINHA</span>
          </span>
        </div>
        <div className="flex items-center gap-6">
          <span className="text-slate-400 font-bold tracking-wide">CONTACT INFO:</span>
          <div className="flex items-center gap-4">
            <a 
              href="mailto:sudhanshutheking183@gmail.com" 
              title="Email Sudhanshu"
              className="text-slate-300 hover:text-[#00f5ff] hover:scale-110 transition-all flex items-center gap-1.5 bg-white/[0.04] px-2.5 py-1 rounded border border-white/[0.08]"
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect width="20" height="16" x="2" y="4" rx="2" />
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
              </svg>
              <span className="hidden sm:inline text-[11px] font-semibold text-slate-400 hover:text-[#00f5ff]">Email</span>
            </a>
            <a 
              ...
              className="text-slate-300 hover:text-[#a855f7] hover:scale-110 transition-all flex items-center gap-1.5 bg-white/[0.04] px-2.5 py-1 rounded border border-white/[0.08]"
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="hidden sm:inline text-[11px] font-semibold text-slate-400 hover:text-[#a855f7]">LinkedIn</span>
            </a>
          </div>
        </div>
      </div>
